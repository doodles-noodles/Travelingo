...
public class Main2Activity extends AppCompatActivity implements GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener, com.google.android.gms.location.LocationListener , OnMapReadyCallback, TaskLoadedCallback{
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        CameraPosition googlePlex = CameraPosition.builder()
                .target(new LatLng(13.3490,74.7856))
                .zoom(7)
                .bearing(0)
                .tilt(45)
                .build();
...
//            });
            ...
            s1=intent.getStringExtra("coor1");
            v1=Double.parseDouble(s1);
            s2=intent.getStringExtra("coor2");
            ...
            place2 = new MarkerOptions().position(new LatLng(v1, v2)).title("Location 2");
